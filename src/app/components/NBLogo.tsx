...
export default function NBLogo({ scrollRange = 1600 }: { scrollRange?: number }) {
  ...
  const edgeMask = "linear-gradient(to bottom, transparent 0%, black 38%, black 62%, transparent 100%)";
  ...
  return (
    <>
      ...
      <video
        ...
        className="fixed inset-0 w-full h-full object-contain md:object-cover z-0 pointer-events-none origin-center md:scale-100 scale-[0.98]"
        style={{
          opacity: 0.35,
          maskImage: edgeMask,
